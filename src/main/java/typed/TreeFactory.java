...
import typed.impl.section.ModuleSectionTreeImpl;
 ...
 */
    ...
    private PropertyTree createPair(InternalSyntaxToken keyToken, Optional<List<StringLiteralTree>> nestedObjects, ValueTree value) {
        ...
        switch (key) {
            ...
            case "module":
                return new ModuleSectionTreeImpl(keyToken, nestedObjects.orNull(), value);
            default:
    ...
    /* Pattern: key = value */
    public PropertyTree pair(InternalSyntaxToken key, InternalSyntaxToken colonToken, ValueTree value) {
        return new PropertyTreeImpl(key, null, colonToken, value);
    }
